...
export default function testSort() {
  ...
  async function sortFormData() {
    try {
      await axios.post("https://the-berkeley-project-website.uc.r.appspot.com:8080/server/sort-form-data");
    } catch (err) {
      alert(err);
    }
  }
  ...
  async function matchVolunteersToSites() {
    try {
      await axios.get("https://the-berkeley-project-website.uc.r.appspot.com:8080/server/match-volunteers-to-sites");
    } catch (err) {
      alert(err);
    }
  }
